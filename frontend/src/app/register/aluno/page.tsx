    ...
    <AuthShell>
      <Card className="w-full border border-[#585759]/35 bg-[#0D0D0D]/90 shadow-xl backdrop-blur-xl">
        <CardHeader className="space-y-3 pb-4 text-center">
          <CardTitle className="text-xl font-semibold tracking-tight text-white">Portal do aluno</CardTitle>
          <p className="text-sm text-[#585759]">Use o link enviado pela academia. Confirme o e-mail antes de entrar.</p>
        </CardHeader>
        <CardContent>
          {!academiaId && (
